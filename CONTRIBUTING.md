...
2. Fork the repository by clicking on the ["Fork"](https://github.com/MihirRajeshPanchal/commentcleaner/fork) button at the top right corner of the page.


3. Once you are in your fork the url should look something like
`https://github.com/<YOUR-USERNAME>/commentcleaner/`
...
- For HTTP
 ```
   git clone https://github.com/<YOUR-USERNAME>/commentcleaner.git
 ```
- For SSH
 ```bash
   git clone git@github.com:<YOUR-USERNAME>/commentcleaner.git
 ```
...
5. Now you are in the `commentcleaner` folder
...
>NOTE: Please make sure to follow the [Code of conduct](https://github.com/MihirRajeshPanchal/commentcleaner/blob/master/CODE_OF_CONDUCT.md) while contributing.
